// This is the critical fix - ensure the module is properly defined globally
var DriversModule;

// Drivers Module - Standalone module for drivers management
(function() {
    // Create the module and assign it to the global scope
    DriversModule = (function() {
        // Private variables
        let driversList;
        let statusFilter;
        let addDriverBtn;
        ...
        // GitHub Service - Local copy for this module
        const githubService = {
